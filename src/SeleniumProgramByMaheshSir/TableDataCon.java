...
public class TableDataCon {
	...
	public static void main(String[] args) {
	 ...
	 expectedAnlayst.add("S148103");
	 expectedAnlayst.add("S148107");

	 	
	List<WebElement>allheaders=driver.findElements(By.xpath("//table[@id='VisitingTable']//tbody/tr/td[7][text()>10]/preceding-sibling::td[5]"));
